...
module.exports = function (callback) {
    return function (res) {
        ...
        var match = contentType.match(/multipart\/x-mixed-replace;boundary=(.*)/);
        if (match) {
            boundary = match[1] + "\r\n";
        }
                ...
                switch (state) {
                    ...
                    case "header":
                        ...
                        if (bodyIndex !== -1) {
                            ...
                            buffer = buffer.slice(0, bodyIndex + 4);
                            state = "body";
                        } else {
                            return;
                        }
